...
(cl:defclass <TrajectoryMsg> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (trajectory
    :reader trajectory
    :initarg :trajectory
    :type (cl:vector hunter_local_planner-msg:TrajectoryPointMsg)
   :initform (cl:make-array 0 :element-type 'hunter_local_planner-msg:TrajectoryPointMsg :initial-element (cl:make-instance 'hunter_local_planner-msg:TrajectoryPointMsg))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TrajectoryMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrajectoryMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hunter_local_planner-msg:<TrajectoryMsg> is deprecated: use hunter_local_planner-msg:TrajectoryMsg instead.")))
...
(cl:defmethod trajectory-val ((m <TrajectoryMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hunter_local_planner-msg:trajectory-val is deprecated.  Use hunter_local_planner-msg:trajectory instead.")
  (trajectory m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TrajectoryMsg>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'trajectory)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'hunter_local_planner-msg:TrajectoryPointMsg))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TrajectoryMsg>)))
  ...
  "hunter_local_planner/TrajectoryMsg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TrajectoryMsg)))
  "Returns string type for a message object of type 'TrajectoryMsg"
  "hunter_local_planner/TrajectoryMsg")
