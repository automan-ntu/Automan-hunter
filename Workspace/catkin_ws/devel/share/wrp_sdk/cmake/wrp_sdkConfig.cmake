...
if(NOT "/robot/Automan-hunter/Workspace/catkin_ws/src/wrp_sdk/include " STREQUAL " ")
  set(wrp_sdk_INCLUDE_DIRS "")
  set(_include_dirs "/robot/Automan-hunter/Workspace/catkin_ws/src/wrp_sdk/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'wrp_sdk' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/robot/Automan-hunter/Workspace/catkin_ws/src/wrp_sdk/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /robot/Automan-hunter/Workspace/catkin_ws/devel/lib;/opt/ros/noetic/lib)
