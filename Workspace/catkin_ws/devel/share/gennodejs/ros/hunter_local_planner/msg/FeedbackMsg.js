...
// (in-package hunter_local_planner.msg)
...
class FeedbackMsg {
  ...
  static datatype() {
    ...
    return 'hunter_local_planner/FeedbackMsg';
  }
  ...
  static messageDefinition() {
    ...
    hunter_local_planner/TrajectoryMsg[] trajectories
    ...
    ================================================================================
    MSG: hunter_local_planner/TrajectoryMsg
    # Message that contains a trajectory for mobile robot navigation
    
    std_msgs/Header header
    hunter_local_planner/TrajectoryPointMsg[] trajectory
    
    
    
    ================================================================================
    MSG: hunter_local_planner/TrajectoryPointMsg
