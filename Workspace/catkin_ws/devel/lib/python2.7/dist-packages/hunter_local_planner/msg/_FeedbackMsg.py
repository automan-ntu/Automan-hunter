...
"""autogenerated by genpy from hunter_local_planner/FeedbackMsg.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','hunter_local_planner/TrajectoryMsg[]','uint16','costmap_converter/ObstacleArrayMsg']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = hunter_local_planner.msg.TrajectoryMsg()
        _v21 = val1.header
        start = end
        end += 4
        ...
        val1.trajectory = []
        for i in range(0, length):
          val2 = hunter_local_planner.msg.TrajectoryPointMsg()
          _v23 = val2.pose
          _v24 = _v23.position
          _x = _v24
          start = end
