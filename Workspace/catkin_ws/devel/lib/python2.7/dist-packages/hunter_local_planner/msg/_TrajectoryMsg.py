...
"""autogenerated by genpy from hunter_local_planner/TrajectoryMsg.msg. Do not edit."""
import codecs
import sys
...
class TrajectoryMsg(genpy.Message):
  ...
  _type = "hunter_local_planner/TrajectoryMsg"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','hunter_local_planner/TrajectoryPointMsg[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = hunter_local_planner.msg.TrajectoryPointMsg()
        _v11 = val1.pose
        _v12 = _v11.position
        _x = _v12
        start = end
