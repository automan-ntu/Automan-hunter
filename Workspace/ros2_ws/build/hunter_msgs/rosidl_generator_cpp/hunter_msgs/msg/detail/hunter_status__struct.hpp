...
struct HunterStatus_
{
  ...
  : header(_init)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->motor_states.fill(hunter_msgs::msg::HunterMotorState_<ContainerAllocator>{_init});
    }
  }
    ...
    motor_states(_alloc)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->fault_code = 0;
      this->battery_voltage = 0.0;
      this->motor_states.fill(hunter_msgs::msg::HunterMotorState_<ContainerAllocator>{_alloc, _init});
    }
  }
  ...
  using _motor_states_type =
    std::array<hunter_msgs::msg::HunterMotorState_<ContainerAllocator>, 3>;
  ...
  Type & set__motor_states(
    const std::array<hunter_msgs::msg::HunterMotorState_<ContainerAllocator>, 3> & _arg)
  {
  ...
  static constexpr int8_t MOTOR_ID_FRONT =
    0;
...
constexpr int8_t HunterStatus_<ContainerAllocator>::MOTOR_ID_FRONT;
template<typename ContainerAllocator>
