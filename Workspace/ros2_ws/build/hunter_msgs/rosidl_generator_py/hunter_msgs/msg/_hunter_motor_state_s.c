...
bool hunter_msgs__msg__hunter_motor_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hunter_msgs.msg._hunter_motor_state.HunterMotorState", full_classname_dest, 52) == 0);
  }
  hunter_msgs__msg__HunterMotorState * ros_message = _ros_message;
  {  // current
...
{
  /* NOTE(esteve): Call constructor of HunterMotorState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hunter_msgs.msg._hunter_motor_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HunterMotorState");
